/*
 *  @(#) synthesis_filter.cc 1.13, last edit: 6/15/94 16:51:52
...
static const real cos1_64  = 1.0 / (2.0 * cos(PI        / 64.0));
static const real cos3_64  = 1.0 / (2.0 * cos(PI * 3.0  / 64.0));
static const real cos5_64  = 1.0 / (2.0 * cos(PI * 5.0  / 64.0));
static const real cos7_64  = 1.0 / (2.0 * cos(PI * 7.0  / 64.0));
static const real cos9_64  = 1.0 / (2.0 * cos(PI * 9.0  / 64.0));
static const real cos11_64 = 1.0 / (2.0 * cos(PI * 11.0 / 64.0));
static const real cos13_64 = 1.0 / (2.0 * cos(PI * 13.0 / 64.0));
static const real cos15_64 = 1.0 / (2.0 * cos(PI * 15.0 / 64.0));
static const real cos17_64 = 1.0 / (2.0 * cos(PI * 17.0 / 64.0));
static const real cos19_64 = 1.0 / (2.0 * cos(PI * 19.0 / 64.0));
static const real cos21_64 = 1.0 / (2.0 * cos(PI * 21.0 / 64.0));
static const real cos23_64 = 1.0 / (2.0 * cos(PI * 23.0 / 64.0));
static const real cos25_64 = 1.0 / (2.0 * cos(PI * 25.0 / 64.0));
static const real cos27_64 = 1.0 / (2.0 * cos(PI * 27.0 / 64.0));
static const real cos29_64 = 1.0 / (2.0 * cos(PI * 29.0 / 64.0));
static const real cos31_64 = 1.0 / (2.0 * cos(PI * 31.0 / 64.0));
static const real cos1_32  = 1.0 / (2.0 * cos(PI        / 32.0));
static const real cos3_32  = 1.0 / (2.0 * cos(PI * 3.0  / 32.0));
static const real cos5_32  = 1.0 / (2.0 * cos(PI * 5.0  / 32.0));
static const real cos7_32  = 1.0 / (2.0 * cos(PI * 7.0  / 32.0));
static const real cos9_32  = 1.0 / (2.0 * cos(PI * 9.0  / 32.0));
static const real cos11_32 = 1.0 / (2.0 * cos(PI * 11.0 / 32.0));
static const real cos13_32 = 1.0 / (2.0 * cos(PI * 13.0 / 32.0));
static const real cos15_32 = 1.0 / (2.0 * cos(PI * 15.0 / 32.0));
static const real cos1_16  = 1.0 / (2.0 * cos(PI        / 16.0));
static const real cos3_16  = 1.0 / (2.0 * cos(PI * 3.0  / 16.0));
static const real cos5_16  = 1.0 / (2.0 * cos(PI * 5.0  / 16.0));
static const real cos7_16  = 1.0 / (2.0 * cos(PI * 7.0  / 16.0));
static const real cos1_8   = 1.0 / (2.0 * cos(PI        / 8.0));
static const real cos3_8   = 1.0 / (2.0 * cos(PI * 3.0  / 8.0));
static const real cos1_4   = 1.0 / (2.0 * cos(PI / 4.0));
