 ...
 *   "IRIX" are used here for identification purposes only.  This
 *   software and its author are not affiliated with Silicon Graphics, Inc.
 */
...
#ifndef LINT
static char *_os_irix_h_ident_ = "@(#)os_irix.h	5.4 94/12/28";
#endif
